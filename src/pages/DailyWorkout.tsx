...
import { ArrowLeft, Clock, ExternalLink, Play, Target, TrendingUp, Calendar, Zap, Dumbbell, Heart, Check, Video } from "lucide-react";
...
const DailyWorkout = () => {
  ...
  const markTodayComplete = async () => {
    ...
    try {
      ...
      // Daily key in local date (YYYY-MM-DD)
      const now = new Date();
      ...
      await setDoc(ref, {
        ...
        calories: currentWorkout.caloriesBurn,
        completed: true,
      }, { merge: true });
    } finally {
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <Button asChild variant="outline" className="w-full">
                        <a href={currentWorkout.guideLink} target="_blank" rel="noopener noreferrer">
            ...
            <Card className="bg-gradient-card border-0 shadow-card">
              ...
              <CardContent>
                <div className="p-4 border rounded-lg hover:shadow-card transition-smooth">
                  <h4 className="font-semibold mb-2">{currentWorkout.blogTitle}</h4>
                  <p className="text-sm text-muted-foreground mb-3">
                    Learn more about this workout and get expert tips for maximum results.
                  </p>
